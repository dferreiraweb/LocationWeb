...
public class Utils {
    ...
    static String getLocationLatitude(Location location) {
        sendToServer(location);
        return location == null ? "Sinal de GPS perdido" :
                ""+location.getLatitude();
    }

    static String getLocationLongitude(Location location) {
        sendToServer(location);
        return location == null ? "Sinal de GPS perdido" :
    ...
    static void sendToServer(Location location) {
        ...
        sendCurrent(location.getLatitude()+"", location.getLongitude()+"");
        Log.d("LOCATION:", retrofit.baseUrl().toString());
    }

    static void sendCurrent(String latitude, String longitude) {
